...
use huddle::{
    ...
    begin_huddle_capture, check_pipeline_hotstart, close_huddle_companion, confirm_huddle_active,
    disable_realtime_voice, download_voice_models, enable_realtime_voice, end_huddle,
    end_huddle_capture, get_huddle_agent_pubkeys, get_huddle_state, get_model_status,
    get_voice_input_mode, interrupt_huddle_speech, join_huddle, leave_huddle, open_huddle_window,
    push_audio_pcm,
...
pub fn run() {
    ...
    let app = app_menu::install(builder)
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            open_huddle_window,
            begin_huddle_capture,
            end_huddle_capture,
            enable_realtime_voice,
            disable_realtime_voice,
            push_audio_pcm,
