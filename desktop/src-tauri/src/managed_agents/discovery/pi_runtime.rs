...
pub(super) const PI_RUNTIME: KnownAcpRuntime = KnownAcpRuntime {
    ...
    adapter_install_commands: &["npm install -g https://github.com/malkovitc/buzz/releases/download/pi-acp-v0.2.6/buzz-pi-acp-0.2.6.tgz"],
    cli_install_instructions_url: "https://github.com/badlogic/pi-mono",
    adapter_install_instructions_url: "https://github.com/malkovitc/buzz/tree/pi-acp-v0.2.6/tools/pi-acp",
    cli_install_hint: "Install Pi 0.84.2; the pi-acp pilot adapter is packaged separately.",
    adapter_install_hint: "Install the reviewed pi-acp 0.2.6 pilot package before selecting this runtime.",
    skill_dir: None,
...
const MIN_PI_ACP_VERSION: (u64, u64, u64) = (0, 2, 6);
